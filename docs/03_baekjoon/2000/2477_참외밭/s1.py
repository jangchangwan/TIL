...
if max_row_idx > max_col_idx:
    min_row = data_lst[(max_row_idx+2) % 6][1]
    min_col = data_lst[(max_col_idx+4) % 6][1]
else :
    min_row = data_lst[(max_row_idx + 4) % 6][1]
    min_col = data_lst[(max_col_idx + 2) % 6][1]
